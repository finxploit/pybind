...
c
         ...
         call nufft3d1(nj,xj,yj,zj,cj,iflag,eps,ms,mt,mu,fk1,
     1        fw,lw,lused,ier)
         print *, ' ier = ',ier
         print *, ' lused = ',lused
...
c     -----------------------
         ...
         call nufft3d2(nj,xj,yj,zj,cj1,iflag,eps,ms,mt,mu,fk1,
     1        fw,lw,lused,ier)
         print *, ' ier = ',ier
         print *, ' lused = ',lused
...
c
         ...
         call nufft3d3(nj,xj,yj,zj,cj,iflag,eps,nk,sk,tk,uk,fk1,
     1        fw,lw,lused,ier)
         print *, ' ier = ',ier
         print *, ' lused = ',lused
